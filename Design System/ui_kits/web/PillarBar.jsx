// PillarBar — one pillar (prix or sémantique). Bar + legend.

const PillarBar = ({ name, score, max, color, legend, deltaPct }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12 }}>
        <span style={{ fontFamily: "var(--font-sans)", fontSize: 14, fontWeight: 600, color: "var(--ink)" }}>{name}</span>
        <span style={{ fontFamily: "var(--font-mono)", fontSize: 14, color: "var(--ink)", fontVariantNumeric: "tabular-nums", whiteSpace: "nowrap" }}>
...
Object.assign(window, { PillarBar });
